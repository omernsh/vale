...
public class CustomAdapter_Tes_Bekleyen extends ArrayAdapter<Veriler> {

    private FirebaseUser firebaseUser;

    public CustomAdapter_Tes_Bekleyen(Context context, ArrayList<Veriler> chatList, FirebaseUser firebaseUser) {
